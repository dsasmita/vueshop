    ...
    <div>
        ...
        <v-container grid-list-md="">
            ...
            <v-layout row="" wrap="">
                ...
                <v-flex :key="index" v-for="(book, index) in books" xs6="">
                    <v-card :to="'/book/'+ book.slug">
                        <v-img :src="getImage('/books/'+book.cover)" height="150px">
                            <v-container fill-height="" fluid="" pa-2="">
                                <v-layout fill-height="">
                                    <v-flex align-end="" flexbox="" xs12="">
                                        <span class="title white--text text-block" v-text="book.title">
                                        </span>
                                    </v-flex>
                                </v-layout>
                            </v-container>
...
<script>
    export default {
        ...
        created() {
            ...
            this.axios.get('/categories/random/' + count).then((response) => {
            ...
            this.axios.get('/books/top/' + count).then((response) => {
